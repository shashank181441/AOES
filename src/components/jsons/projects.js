...
export const projects = [
    {
      name: "AO Vending Machine",
      shortName: "AO Vending",
      description: "Our vending machine merges technology with user convenience. Your go-to solution for a quick snack.",
    ...
    },
    {
      ...
      Nepal's growing dance culture, influenced by global trends, makes Dancerush Stardom a perfect fit. Many professional dancers use this game as part of their training to hone rhythm and footwork. Its appeal extends to tourists who enjoy immersing themselves in the local gaming culture. This game has not only brought entertainment but has also become a platform for fostering community connections and healthy lifestyles.`,
      img: "https://files.catbox.moe/z4w993.png",
      smallImg: "https://files.catbox.moe/myd2s3.jpeg",
      slug: "dancerush-stardom",
    },
    {
      name: "Sanitary Pad Vending Machine",
      shortName: "Pad Vending",
      description: "A convenient, on-demand solution for dispensing sanitary pads in public and private spaces.",
    ...
    },
    {
      ...
      Furthermore, the IR Cooking Stove has been embraced by eco-conscious Nepali households and restaurants. By reducing carbon emissions and promoting clean energy, it aligns with Nepal’s commitment to environmental preservation. The stove is also affordable, with subsidies provided by local governments and organizations promoting green technology, making it an accessible solution for sustainable cooking throughout Nepal.`,
      img: "https://files.catbox.moe/qsp44w.png",
      smallImg:"https://files.catbox.moe/806sau.jpeg",
      slug: "ir-cooking-stove",
    },
  ];
